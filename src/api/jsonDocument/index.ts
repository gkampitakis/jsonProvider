...
jsonDocRouter.put('/:id', controllerDI.update); //TODO: in future we should email notifications here

/** Privacy */ jsonDocRouter.put('/privacy/:id/:privacy', controllerDI.updatePrivacy);
